	...
	var bankApp = function bankApp() {
	  ...
	  switch (action.type) {
	    case _actions.DEPOSIT:
	      ...
	      return _extends({}, state, toChange);

	    case _actions.WITHDRAW:
	      if (action.account === 'checking') {
	        toChange.checking = state.checking - action.amount;
	      } else if (action.account === 'savings') {
	        toChange.savings = state.savings - action.amount;
	    ...
	    case _actions.TRANSFER:
	      toChange.checking = action.from === 'checking' ? state.checking - action.amount : state.checking + action.amount;
	      toChange.savings = action.from === 'savings' ? state.savings - action.amount : state.savings + action.amount;
	      return _extends({}, state, toChange);
...
/***/ function(module, exports) {
	...
	var TRANSFER = exports.TRANSFER = 'TRANSFER';

	// helper that returns action creator:

	var bankAction = function bankAction(type) {
	...
	var deposit = exports.deposit = bankAction(DEPOSIT);
	var withdraw = exports.withdraw = bankAction(WITHDRAW);
	var transfer = exports.transfer = function transfer(amount, from, to) {
	  return {
	    type: TRANSFER,
	    amount: amount,
	    from: from,
